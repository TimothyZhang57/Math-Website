//Controller for grade 10 Analytic Geometry Page
//Refer to comments on MeasurementsCtrl.js
angular.module('Analytic10Ctrl', []).controller('Analytic10Controller', function($scope, $http,$window, $location) {
	$http.get('/api/Analytic10').
