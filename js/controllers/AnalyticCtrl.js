//Controller for Analytic Geometry Page
//Refer to comments on Measurements Ctrl 
angular.module('AnalyticCtrl', []).controller('AnalyticController', function($scope, $http,$window, $location) {
	$http.get('/api/Analytic').
