//Controller for grade 12 Characteristics of Functions Page
//Refer to comments on Measurements Ctrl 
angular.module('Character12Ctrl', []).controller('Character12Controller', function($scope, $http,$window, $location) {
	$http.get('/api/CharacteristicOFunctions12').
