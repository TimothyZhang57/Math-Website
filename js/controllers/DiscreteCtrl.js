//Controller for Discrete Functions Page
//Refer to comments on Measurements Ctrl 
angular.module('DiscreteCtrl', []).controller('DiscreteController', function($scope, $http,$window, $location) {
	$http.get('/api/Discrete').
