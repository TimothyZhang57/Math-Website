//Controller for Exponential Functions Page
//Refer to comments on Measurements Ctrl 
angular.module('ExponentCtrl', []).controller('ExponentController', function($scope, $http,$window, $location) {
	$http.get('/api/Exponential').
