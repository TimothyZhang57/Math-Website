//Controller for the quadratic relations Page
//Refer to comments on Measurements Ctrl 
angular.module('QuadraticCtrl', []).controller('QuadraticController', function($scope, $http,$window, $location) {
	$http.get('/api/Quadratic').
