//Controller for the Trigonmetric functions  Page
//Refer to comments on Measurements Ctrl 
angular.module('TrigonometricCtrl', []).controller('TrigonometricController', function($scope, $http,$window, $location) {
	$http.get('/api/Trigonometric').
