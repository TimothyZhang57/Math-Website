//Controller for Linears Relations Page
//Refer to comments on Measurements Ctrl 
angular.module('linearRelationsCtrl', []).controller('linearRelationsController', function($scope, $http,$window, $location) {
	$http.get('/api/LinearRelations').
